        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Settings for Marks Entry</div>
                    <div class="panel-body">
                        <a href="{{ url('/admin/marks-entry/editMarks') }}" title="Back"><button class="btn btn-warning btn-xs"><i class="fa fa-arrow-left" aria-hidden="true"></i> Edit Marks </button></a>
                        <br />
                        <br />
                        ...
                        {!! Form::open(['method'=>'get','url' => '/admin/marks-entry/newCreate', 'class' => 'form-horizontal', 'files' => true]) !!}
                            ...
                            <div class="form-group {{ $errors->has('exam') ? 'has-error' : ''}}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    @foreach($exams as $exam)
                                        <option value="{{ $exam->id }}" @if($exam->id == 3) selected @endif> {{ $exam->title }}  </option>
                                    @endforeach
                                    </select>
